...
public class TouristicspotFragment extends Fragment {
	...
	public TouristicspotFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        View rootView = inflater.inflate(R.layout.fragment_touristicspot, container, false);

        // get the expandable listview
        expListView = (ExpandableListView) rootView.findViewById(R.id.expSpot);
	...
	private void fillData() {
		...
		final ArrayList<Tourism> listOfTourism = dataSource.getTourismSpot();
